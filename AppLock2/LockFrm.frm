...
If Text1 = Text2 Then
Name "" + Label4.Caption + "" As "" + Label4.Caption + ".lck"
Else
MsgBox "Incorrect Password Entered. Application will not be locked.", vbOKOnly + vbCritical, "Password Error"
End If
Unload Me
End Sub
