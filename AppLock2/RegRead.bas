...
FirstRun = GetString(HKEY_CURRENT_USER, "Software\AppLock2\", "FirstRun")
End Function
Function GetAppPath() As String
GetAppPath = GetString(HKEY_CURRENT_USER, "Software\AppLock2\", "AppPath")
End Function
Function GetPassword() As String
GetPassword = GetString(HKEY_CURRENT_USER, "Software\AppLock2\", "Password")
End Function
